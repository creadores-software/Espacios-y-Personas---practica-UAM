        ...
        <div class="card-body">
          ...
          <form @submit.prevent="submit">
            <o-field
              ...
              maxlength="100"
            >
              <o-input type="name" v-model="form.name" value=""> </o-input>
            </o-field>
            <o-field
              label="Descripción"
              ...
              maxlength="200"
            >
              <o-input type="textarea" v-model="form.description" value=""> </o-input>
            </o-field>
            <o-field
              label="Capacidad"
            ...
            >
              <o-input type="number" v-model="form.capacity" value=""> </o-input>
            </o-field>
            <o-field
              label="Zona"
              ...
              :message="errors.zone"
            >
              <o-input type="text" v-model="form.zone" value=""> </o-input>
            </o-field>
            <o-field
              label="Latitud"
...
export default {
  ...
  methods: {
    getSpace() {
      this.$axios
        .get("/api/space/slug/" + this.$route.params.slug,this.config)
        .then((res) => {
          this.space = res.data;
          if (this.space) {
    ...
    submit() {
      ...
      if (this.labelSubmit == "Guardar") {
        ...
        if (!this.hasErrors) {
          this.$axios
            .get("/api/person/buildSlug/" + this.form.name,this.config)
            .then((res) => {
              this.spaceSlug = res.data;
              this.$axios
                .get("/api/space/slug/" + this.spaceSlug,this.config)
                .then((res) => {
                  this.space = res.data;
                  if (this.space) {
                ...
                .catch((err) => {
                  ...
                  this.$axios
                    .post("/api/space", this.form,this.config)
                    .then((res) => {
        ...
        if (!this.hasErrors) {
          this.$axios
            ...
            .then((res) => {
              ...
              this.$axios
                .put("/api/space/" + this.firstSpaceSlug, this.form,this.config)
                .then((res) => {
                  oruga.notification.open({
                    duration: 5000,
